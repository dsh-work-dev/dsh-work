...
export enum ErrorCode {
    ...
    ErrorChannelUnavailable = "WORKER_CHANNEL_UNAVAILABLE",
    ErrorChannelStartFailed = "WORKER_CHANNEL_START_FAILED",
    ErrorChannelCloseFailed = "WORKER_CHANNEL_CLOSE_FAILED",
