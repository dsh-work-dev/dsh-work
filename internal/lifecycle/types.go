...
const (
	...
	ErrorChannelUnavailable         ErrorCode = "WORKER_CHANNEL_UNAVAILABLE"
	ErrorChannelStartFailed         ErrorCode = "WORKER_CHANNEL_START_FAILED"
	ErrorChannelCloseFailed         ErrorCode = "WORKER_CHANNEL_CLOSE_FAILED"
